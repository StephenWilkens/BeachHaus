...
import { HopIcon, BeerIcon, ScrollIcon } from "lucide-react";
...
export function BreweryLandingPageContractBrewContentRow() {
  return (
    <div className="w-full md:min-h-[560px] lg:max-h-[720px] 2xl:max-h-[1080px]">
      ...
      <div className="desktop group relative hidden lg:flex bg-black">
        <Image
          src={brew}
          alt="Brew"
          className="w-full object-cover lg:max-h-[720px] 2xl:max-h-[1080px] opacity-90 group-hover:opacity-70 transition delay-200"
        />
